...
import com.motorcli.springboot.restful.auth.token.RawAccessToken;
import com.motorcli.springboot.restful.config.AbstractAuthJWTConfiguration;
...
public class TokenAuthenticationProcessingFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        String tokenPayload = request.getHeader(AbstractAuthJWTConfiguration.TOKEN_HEADER_PARAM);
