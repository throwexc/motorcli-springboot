    ...
    function(t) {
            ...
            var t = f(regeneratorRuntime.mark(function t(n) {
                ...
                return regeneratorRuntime.wrap(function(t) {
                    for (;;) switch (t.prev = t.next) {
                        ...
                        case 7:
                            t.prev = 7, t.t0 = t.
                            catch (0), console.error("Add csrf header encounter error", t.t0);
                        case 10:
                        case "end":
                            return t.stop()
                    }
        ...
        window.onload = function() {
            var t, n = (t = u(regeneratorRuntime.mark(function t(e) {
                    ...
                    return regeneratorRuntime.wrap(function(t) {
                        for (;;) switch (t.prev = t.next) {
                            ...
                            case 18:
                                ...
                                break;
                            case 23:
                                return t.prev = 23, t.t0 = t.
                                catch (0), t.next = 27, prompt("Unable to infer base url. This is common when using dynamic servlet registration or when the API is behind an API Gateway. The base url is the root of where all the swagger resources are served. For e.g. if the api is available at http://example.org/api/v2/api-docs then the base url is http://example.org/api/. Please enter the location manually: ", window.location.href);
                            case 27:
                ...
                e = function() {
                    return /(.*)\/api.html.*/.exec(window.location.href)[1]
                };
        ...
        i(i.S + i.F * !r(57)(function(t) {
            ...
            from: function(t) {
                var n, r, i, l, h = o(t),
                    ...
                    y = 0,
                    m = s(h);
                if (g && (d = e(d, v > 2 ? arguments[2] : void 0, 2)), void 0 == m || p == Array && c(m)) for (r = new p(n = a(h.length)); n > y; y++) f(r, y, g ? d(h[y], y) : h[y]);
                else for (l = m.call(h), r = new p; !(i = l.next()).done; y++) f(r, y, g ? u(l, d, [i.value, y], !0) : i.value);
                return r.length = y, r
            }
        })
    }, function(t, n, r) {
